          ...
          <div className="row g-4">
            ...
            <div className="col-12 col-md-4">
              <div className="text-center p-3">
                ...
                <p className="text-muted">
                  We target the problem and define essential parameters to solve
                  it. We then send you reports for feedback and discussion,
                  keeping the process moving in the desired direction.
                </p>
              </div>
            </div>
            <div
            ...
            <div className="col-12 col-md-4">
              <div className="text-center p-3">
                ...
                <p className="text-muted">
                  We have the ability to achieve goals through a well-designed
                  procedure that avoids any last minute problems.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row g-4">
            <div className="col-12 col-md-4">
              <div className="text-center p-3">
                ...
                <h2 className="h4 mb-3">Creating Content</h2>
                <p className="text-muted">
                  Whether web development or digital marketing, our specialists
                  will work with you to provide the best and most unique
            ...
            <div className="col-12 col-md-4">
              <div className="text-center p-3">
                ...
                <h2 className="h4 mb-3">Team</h2>
                <p className="text-muted">
                  We have a worldwide team of deeply vetted experts dedicated to
            ...
            <div className="col-12 col-md-4">
              <div className="text-center p-3">
                ...
                <h2 className="h4 mb-3">Ensuring High ROI</h2>
                <p className="text-muted">
                  You'll definitely get more from what you plant, but you have
                  to believe us.
                </p>
              </div>
            </div>
